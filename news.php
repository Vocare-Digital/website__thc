...
<head>
    ...
    <!-- Site Properties -->
    <title>Latest news - Totally Healthcare</title>
...
<?php require_once('menu.php'); ?>
  ...
  <div class="mini-container" style="padding-top: 4em">
    <div class="ui stackable grid">
      <div class="ten wide column">
        <div class="ui divided items">
             <div class="item">
            <div class="content">
              <a class="header" name="july16"><h2>Kaye Drew blog</h2> - 16 July 2020</a>
               <div class="description">
                   <p style="font-style: italic;">Following the pause of many elective procedures during COVID-19, Totally Healthcare (THC) continues forward into the new 'business as usual' as it restarts its services across the UK and Ireland. In the most recent THC blog Kaye Drew, Clinical Mobilisation Lead for THC, Totally plc's insourcing division, shares key insights on delivering healthcare post-COVID-19 following a recent endoscopy service mobilisation.</p>
                <img class="ui small left floated image" src="assets/images/KayePPE.png" alt="Kaye wearing PPE" />                  
                   <p>As a Senior Endoscopy Nurse with over 40 years’ experience it is clear to me the impact of COVID-19 has been far reaching for healthcare professionals and patients across the world. While healthcare has been focused toward emergency response and urgent care during the pandemic, the pause of key services has caused great concern for many, especially those patients who had experienced ‘red flag’ symptoms. Restarting endoscopy insourcing services has been a key priority to providing some much-needed reassurance and treatment to those worried patients.</p>
                   <p>Following guidance from government bodies, the British Society of Gastroenterology (BSG) and the Joint Advisory Group for GI Endoscopy (JAG), we have been able to safely put our well-established clinical insourcing model into practice and restart our waiting list initiatives.</p>
                   <p>At THC we were delighted for all our staff and patients when we knew it was safe to restart services. It was clear service provision would require new and innovative ways of working and as our clinicians had been dealing with COVID-19 on the frontline during the response we were able to access the best clinical experience and expertise required to continue our high-standard of delivery in the new post-COVID-19 world. </p>
                   <p>To begin with it was critical to carry out the appropriate risk-assessments alongside our quality procedures. All elements of service delivery from the staff’s journey to the hospital, the patients’ journey and the performance of listed procedures were scrutinised against our high-quality model of practice. The provision of appropriate PPE equipment and training in latest practices was also a critical step in the mobilisation process. This planning approach provided assurance to our commissioners that patient and staff safety is paramount.</p>
                   <p>The key to our delivery success is through following our well-established high-quality clinical model of planning, attention to detail, strict adherence to clinical governance procedures and close partnership working to ensure safe solutions. Our clinical teams have always been at the forefront of healthcare, adapting to new guidelines and efficiently working in new innovative ways to get the best result for patients. We are extremely proud of how everyone has adapted and excited to continue our mission of reducing patient waiting lists across the UK and Ireland, while delivering high-quality care and an excellent patient experience. </p>
                </div>
            </div>
          </div>
             <div class="item">
               ...
               <div class="description">
                ...
                <img class="ui small left floated image" src="assets/images/marie-lee-new.jpg">
                 ...
                 <p>In March this year, in response to the pandemic, hospitals were forced to focus on reducing the public health threat from COVID-19 and this meant many elective treatments were put on hold. I commend the hard work of the NHS and healthcare providers across UK and Ireland in their committed fight against the pandemic.</p>
                   ...
                   <p><a href="contact-us.php" title="contact us">Contact us</a></p>
               </div>
            </div>
          </div>  
      ...
      <div class="six wide column">
        <div class="ui purple-box segment">
        ...
        <a class="twitter-timeline" data-lang="en" data-height="1000" data-width="550" data-link-color="#00887A" href="https://twitter.com/TotallyHealthc1?ref_src=twsrc%5Etfw" data-chrome="nofooter">Tweets by Totally Healthcare</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
      </div>
    </div>
  </div>
